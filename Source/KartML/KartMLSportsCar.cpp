...
AKartMLSportsCar::AKartMLSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UKartMLSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UKartMLSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UKartMLSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UKartMLSportsWheelRear::StaticClass();
