...
void UEasyVehicleMovementComponent::SmoothClientPosition_InterpolateAndExtrapolate(float DeltaSeconds)
{
	...
	if (ClientData)
	{
		...
		DrawDebugBox(GetWorld(), LocalPos, FVector(30.0f, 30.0f, 30.0f), LocalRot, FColor::Red, false, -1, 0, 2.0f);
		...
		*/
		...
		DrawDebugBox(GetWorld(), LocalPos, FVector(30.0f, 30.0f, 30.0f), LocalRot, FColor::Green, false, -1, 0, 2.0f);
